            ...
            <div id="container05" class="style1 container default full screen">
              <div class="wrapper">
                <div class="inner" data-onvisible-trigger="1">
                  <p id="text02">Alex Stovall</p>
                  <h1 id="text11" class="style3">FullStack Developer</h1>
                  <hr id="divider01" class="style1" />
                  <p id="text08" class="style2">
                    Creating beautiful web, mobile and blockchain applications end to end. From the UI to the API
                  </p>
                </div>
              </div>
            </div>
...
#main > .inner {
  --padding-horizontal: 6.5rem;
  --padding-vertical: 8.625rem;
  --spacing: 0rem;
  --width: 56rem;
...
p.style3 {
  ...
  line-height: 1.25;
  font-weight: 500;
  background-image: linear-gradient(344deg, #e69639 0%, #b37c40 0%);
...
.buttons.style1 li a {
  ...
  padding-left: calc(0.175rem + 1.75rem);
  font-size: 0.625em;
  font-weight: 600;
  border-radius: 0rem;
  direction: var(--site-language-direction);
